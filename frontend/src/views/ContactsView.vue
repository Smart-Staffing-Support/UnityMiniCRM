        ...
        <v-card elevation="2" class="mb-4">
          <v-card-text class="pa-4">
            <div class="d-flex align-center gap-3 flex-wrap">
              <v-text-field v-model="search" prepend-inner-icon="mdi-magnify" label="Search contacts..."
      ...
      <v-card>
        <v-card-title class="pa-4 bg-grey-lighten-4">
          <div class="d-flex align-center">
            ...
            <span class="text-h6 font-weight-bold">{{
              editedIndex === -1 ? "New Contact" : "Edit Contact"
              }}</span>
          </div>
        </v-card-title>
        <v-divider></v-divider>
        <v-card-text class="pa-6">
          <v-container>
            <v-row>
              <v-col cols="12" sm="6">
                <v-text-field v-model="editedItem.first_name" label="First Name *" variant="outlined" color="primary"
                  prepend-inner-icon="mdi-account" required></v-text-field>
              </v-col>
              <v-col cols="12" sm="6">
                <v-text-field v-model="editedItem.last_name" label="Last Name *" variant="outlined" color="primary"
                  prepend-inner-icon="mdi-account" required></v-text-field>
              </v-col>
              <v-col cols="12">
              ...
              <v-col cols="12" sm="6">
                <v-text-field v-model="editedItem.position" label="Position" variant="outlined" color="primary"
              ...
              <v-col cols="12">
                <v-select v-model="editedItem.company" :items="companies" item-title="name" item-value="id"
                  ...
                  hint="Optional: Select a company to link this contact" persistent-hint></v-select>
              </v-col>
            </v-row>
          </v-container>
        </v-card-text>
